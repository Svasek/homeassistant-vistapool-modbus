...
Only the latest released version receives security fixes. Please update to the newest version before reporting a vulnerability.
...
- An assessment and plan for a fix within **30 days**
